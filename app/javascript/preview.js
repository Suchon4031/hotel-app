document.addEventListener('DOMContentLoaded', function(){
  ...
  const postForm = document.getElementById("new-form");
  ...
  const buildNewFileField = () => {
    ...
    newFileField.setAttribute('name', 'hotel[images][]');

    const lastFileField = document.querySelector('input[type="file"][name="hotel[images][]"]:last-child');
  ...
  const fileField = document.querySelector('input[type="file"][name="hotel[images][]"]');
